...
@section('content')
    <h3 class="text-center"><strong>Account Settings</strong></h3><hr style="margin-top:0px;" />
    ...
    <h3 class="text-center"><strong>Account Security</strong></h3><hr style="margin-top:0px;" />
    <div class="col-xs-12" style="margin-bottom:20px;">
        <div class="row text-center">
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                ...
                <span class="label label-warning">{{ $lastweblogin }}</span>
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                ...
                <span class="label label-warning">{{ $lastgamelogin }}</span>
            </div>
            <div class="col-sm-4">
    ...
    <h3 class="text-center"><strong>Account Rewards</strong></h3><hr style="margin-top:0px;" />
    <div class="col-xs-12" style="margin-bottom:20px;">
        <div class="row text-center">
            <div class="col-sm-4">
